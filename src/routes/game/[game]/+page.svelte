...
<div class="container mx-auto">
	...
	<a href={`/game/${data.game}/new-team`} class="btn btn-primary mb-4">Create a new team</a>
		...
		{#each roster as team, ti}
			<div class="border p-2 rounded">
				<div class="flex justify-between items-center mb-2">
					...
					<button class="btn btn-error btn-sm" onclick={() => deleteTeam(ti)}>Delete</button>
				</div>
				<div class="flex flex-wrap gap-2">
					{#each team as pokemon}
						<div class="w-20 card shadow-sm flex flex-col items-center justify-center p-1 bg-gray-100">
							<figure>
								<img src={pokemon.sprite} alt={toTitleCase(pokemon.name)} class="max-h-16 object-contain"/>
							</figure>
